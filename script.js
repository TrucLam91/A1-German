...
const T = [
  {
    id: 1, emoji: '👋', title: 'Sich vorstellen', sub: 'Greetings & Introductions',
    ...
    reading: {
      ...
      qs: [
        { q: 'Woher kommt Nico?',  a: 'Nico kommt aus Spanien.' },
        { q: 'Wo wohnt Sofia?',    a: 'Sofia wohnt in Hamburg.' },
        { q: 'Wie alt ist Nico?',  a: 'Nico ist 22 Jahre alt.' },
      ],
    },
    ...
    writing: {
      ...
      ex:   'Ich heiße Minh. Ich komme aus Vietnam. Ich wohne in Ho-Chi-Minh-Stadt. Ich bin 24 Jahre alt. Ich bin Student.',
    },
    quiz: [
  ...
  {
    id: 2, emoji: '👨‍👩‍👧‍👦', title: 'Familie', sub: 'Family',
    color: '#e67e22', light: '#fdf5ec',
    key: 'Das ist meine Familie. Mein Vater heißt Klaus. Meine Mutter heißt Petra.',
    ytId: 'gMxLXBcCY_c',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Wie heißt Annas Mutter?', a: 'Annas Mutter heißt Sabine.' },
        { q: 'Wie alt ist Laura?',       a: 'Laura ist 16 Jahre alt.' },
        { q: 'Wo studiert Max?',         a: 'Max studiert in Berlin.' },
      ],
    },
    ...
    writing: {
      task: 'Beschreib deine Familie! ✍️',
      tmpl: 'Mein Vater heißt ___. Meine Mutter heißt ___. Ich habe ___ Bruder/Schwester.',
      ex:   'Mein Vater heißt Minh. Meine Mutter heißt Lan. Ich habe eine Schwester. Sie heißt Hoa und ist 19 Jahre alt.',
    },
    quiz: [
  ...
  {
    id: 3, emoji: '🔢', title: 'Zahlen & Datum', sub: 'Numbers & Dates',
    color: '#27ae60', light: '#edfaf1',
    key: 'Heute ist der 3. März. Ich bin am 15. August geboren.',
    ytId: 'lVW4a_IVGAo',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Wann ist Sophias Geburtstag?', a: 'Sophias Geburtstag ist am 20. April.' },
        { q: 'Wie alt wird Sophia?',          a: 'Sophia wird 25 Jahre alt.' },
        { q: 'Wie viele Personen kommen?',    a: 'Es kommen 15 Personen.' },
      ],
    },
    speaking: ['Heute ist der ___ (Datum).','Ich bin am ___ geboren.','Es ist ___ Uhr.','Das kostet ___ Euro.','Meine Telefonnummer ist ___.'],
    writing: {
      task: 'Schreib dein Geburtsdatum! ✍️',
      tmpl: 'Ich bin am ___ geboren. Ich wohne in ___. Meine Telefonnummer ist ___.',
      ex:   'Ich bin am 5. März 2000 geboren. Ich wohne in Ho-Chi-Minh-Stadt. Meine Telefonnummer ist 0901234567.',
    },
    quiz: [
  ...
  {
    id: 4, emoji: '🍕', title: 'Essen & Trinken', sub: 'Food & Drinks',
    color: '#f39c12', light: '#fefbf0',
    key: 'Ich möchte einen Kaffee, bitte. Was kostet das Schnitzel?',
    ytId: 'KLkGurBLb4Q',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Was kostet das Schnitzel?',       a: 'Das Schnitzel kostet 14 Euro.' },
        { q: 'Was möchte die Frau essen?',      a: 'Die Frau möchte die Suppe.' },
        { q: 'Wie viel kosten beide zusammen?', a: 'Zusammen kostet es 22 Euro.' },
      ],
    },
    speaking: ['Ich möchte ___, bitte.','Was kostet ___?','Das schmeckt sehr lecker!','Die Rechnung, bitte!','Haben Sie vegetarische Gerichte?'],
    writing: {
      task: 'Was isst du zum Frühstück? ✍️',
      tmpl: 'Zum Frühstück esse ich ___. Ich trinke ___. Das ist sehr lecker!',
      ex:   'Zum Frühstück esse ich Brot mit Butter und Marmelade. Ich trinke Kaffee mit Milch. Das ist sehr lecker!',
    },
    quiz: [
  ...
  {
    id: 5, emoji: '🏠', title: 'Wohnen', sub: 'Housing',
    color: '#1abc9c', light: '#edfaf7',
    key: 'Ich wohne in einer Wohnung. Sie hat 3 Zimmer, eine Küche und ein Bad.',
    ytId: 'g1AQMJB0nRw',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Im welchen Stock ist Luises Wohnung?',  a: 'Die Wohnung ist im 2. Stock.' },
        { q: 'Wie viel Quadratmeter hat die Wohnung?',a: 'Die Wohnung hat 65 Quadratmeter.' },
        { q: 'Wie teuer ist die Miete?',              a: 'Die Miete ist 1.200 Euro pro Monat.' },
      ],
    },
    ...
    writing: {
      task: 'Beschreib deine Wohnung! ✍️',
      tmpl: 'Ich wohne in ___. Meine Wohnung hat ___. Es gibt ___.',
      ex:   'Ich wohne in einer Wohnung in Ho-Chi-Minh-Stadt. Meine Wohnung hat 2 Zimmer, eine Küche und ein Bad. Es gibt eine große Terrasse.',
    },
    quiz: [
  ...
  {
    id: 6, emoji: '⏰', title: 'Alltag & Uhrzeiten', sub: 'Daily Life & Time',
    color: '#3498db', light: '#eaf4fd',
    key: 'Ich stehe um 7 Uhr auf. Um 8 Uhr frühstücke ich.',
    ytId: 'XiKSGsQp7x8',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Wann steht Maria auf?',    a: 'Maria steht um 6:30 Uhr auf.' },
        { q: 'Bis wann arbeitet Maria?', a: 'Maria arbeitet bis 17:00 Uhr.' },
        { q: 'Was macht sie um 18 Uhr?', a: 'Um 18 Uhr macht sie Sport.' },
      ],
    },
    speaking: ['Ich stehe um ___ Uhr auf.','Um ___ Uhr frühstücke ich.','Wann kommst du?','Es ist ___ Uhr.','Was machst du am Abend?'],
    writing: {
      task: 'Beschreib deinen Tagesablauf! ✍️',
      tmpl: 'Um ___ Uhr stehe ich auf. Dann frühstücke ich. Um ___ Uhr ___. Am Abend ___.',
      ex:   'Um 6 Uhr stehe ich auf. Dann frühstücke ich. Um 8 Uhr gehe ich zur Arbeit. Am Abend koche ich und schaue fern.',
    },
    quiz: [
  ...
  {
    id: 7, emoji: '⚽', title: 'Freizeit & Hobbys', sub: 'Leisure & Hobbies',
    color: '#9b59b6', light: '#f5f0fb',
    key: 'In meiner Freizeit spiele ich Fußball und lese gern Bücher.',
    ytId: 'IFRYgnFZqQ8',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Was spielt Paul gern?',          a: 'Paul spielt gern Gitarre und Fußball.' },
        { q: 'Was ist Pauls Lieblingshobbys?', a: 'Pauls Lieblingshobbys ist Reisen.' },
        { q: 'Was macht Paul nicht gern?',     a: 'Paul liest und tanzt nicht gern.' },
      ],
    },
    ...
    writing: {
      task: 'Was sind deine Hobbys? ✍️',
      tmpl: 'In meiner Freizeit ___ ich gern. Ich kann auch ___. Am Wochenende ___.',
      ex:   'In meiner Freizeit höre ich gern Musik und lese Bücher. Ich kann auch Volleyball spielen. Am Wochenende koche ich für meine Familie.',
    },
    quiz: [
  ...
  {
    id: 8, emoji: '🛒', title: 'Einkaufen', sub: 'Shopping',
    color: '#e91e63', light: '#fdf0f5',
    key: 'Was kostet das? – Das kostet 5 Euro. Ich nehme das Hemd in Größe M.',
    ytId: 'Z1N-BKZPQ6I',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Was sucht Tom?',                       a: 'Tom sucht ein Hemd.' },
        { q: 'Was kostet das erste Hemd?',            a: 'Das erste Hemd kostet 39 Euro.' },
        { q: 'Was kostet das Hemd im Sonderangebot?', a: 'Das Hemd im Sonderangebot kostet 25 Euro.' },
      ],
    },
    speaking: ['Was kostet ___?','Ich nehme ___.','Haben Sie ___ in Größe M?','Das ist zu teuer!','Ich bezahle mit Karte/bar.'],
    writing: {
      task: 'Schreib einen Einkaufszettel! ✍️',
      tmpl: 'Ich brauche: ___, ___, ___. Das kostet zusammen ca. ___ Euro.',
      ex:   'Ich brauche: 1 kg Äpfel (2 Euro), 500g Käse (4 Euro), 1 Brot (2,50 Euro). Das kostet zusammen ca. 8,50 Euro.',
    },
    quiz: [
  ...
  {
    id: 9, emoji: '🚂', title: 'Unterwegs', sub: 'Getting Around',
    color: '#00bcd4', light: '#e8f9fb',
    key: 'Wie komme ich zum Bahnhof? – Fahren Sie geradeaus, dann links.',
    ytId: '4cBfQiXfWkk',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Wie weit ist der Bahnhof zu Fuß?',      a: 'Der Bahnhof ist etwa 10 Minuten zu Fuß entfernt.' },
        { q: 'Welche U-Bahn-Linie kann man nehmen?',  a: 'Man kann die U-Bahn Linie 3 nehmen.' },
        { q: 'Wohin soll der Tourist an der Ampel?',  a: 'Er soll links abbiegen.' },
      ],
    },
    speaking: ['Wie komme ich zum ___?','Fahren Sie geradeaus.','Biegen Sie links/rechts ab.','Ist es weit?','Eine Fahrkarte nach ___, bitte.'],
    writing: {
      task: 'Beschreib den Weg zur Arbeit/Schule! ✍️',
      tmpl: 'Von meinem Haus fahre/gehe ich ___. Dann ___. Nach ___ Minuten bin ich am Ziel.',
      ex:   'Von meinem Haus fahre ich mit dem Bus. Ich steige an der Haltestelle Innenstadt aus. Dann gehe ich 5 Minuten zu Fuß. Nach 30 Minuten bin ich am Ziel.',
    },
    quiz: [
  ...
  {
    id: 10, emoji: '🏥', title: 'Gesundheit', sub: 'Health',
    color: '#ff5722', light: '#fff3f0',
    key: 'Ich habe Kopfschmerzen. Ich muss zum Arzt gehen.',
    ytId: '6MQiDEt-eB4',
    vocab: [
    ...
    reading: {
      ...
      qs: [
        { q: 'Was hat der Patient?',         a: 'Der Patient hat Kopfschmerzen, Fieber und Halsschmerzen.' },
        { q: 'Wie hoch ist das Fieber?',     a: 'Das Fieber ist 38,5 Grad.' },
        { q: 'Was soll der Patient machen?', a: 'Er soll Tabletten nehmen und zu Hause bleiben.' },
      ],
    },
    ...
    writing: {
      task: 'Du bist krank – schreib eine Krankmeldung! ✍️',
      tmpl: 'Ich bin leider krank. Ich habe ___. Der Arzt sagt, ich muss ___. Ich komme am ___ wieder.',
      ex:   'Ich bin leider krank. Ich habe Fieber und Kopfschmerzen. Der Arzt sagt, ich muss zu Hause bleiben. Ich komme am Montag wieder.',
    },
    quiz: [
...
const G = [
  {
    id: 1, emoji: '🔤', title: 'Artikel: der, die, das', sub: 'Definite articles',
    color: '#e74c3c',
  ...
  {
    id: 2, emoji: '🏃', title: 'sein & haben', sub: 'Most important verb conjugations',
    color: '#3498db',
    ...
    rules: [
      ...
      { r: 'haben – present tense', ex: ['ich habe','du hast','er/sie/es hat','wir haben','ihr habt','sie/Sie haben'], tip: 'haben + noun: Ich habe ein Auto. | haben + Schmerzen (pain)' },
    ],
    ex: [
  ...
  {
    id: 3, emoji: '✂️', title: 'Trennbare Verben', sub: 'Separable verbs',
    color: '#27ae60',
    explain: 'Many verbs have a prefix that splits off and moves to the END of the sentence! Example: aufstehen → Ich stehe auf.',
    rules: [
      { r: 'Structure: prefix splits to end of sentence',
        ex: ['aufstehen → Ich stehe um 7 Uhr auf.','anrufen → Er ruft seine Mutter an.','einkaufen → Wir kaufen im Supermarkt ein.','fernsehen → Sie sieht abends fern.'],
        tip: 'Common prefixes: auf-, an-, ein-, aus-, mit-, vor-, ab-' },
    ],
    ex: [
  ...
  {
    id: 4, emoji: '📌', title: 'Nominativ & Akkusativ', sub: 'Case 1 & Case 4',
    color: '#9b59b6',
    explain: 'Nominativ = subject (who does the action). Akkusativ = direct object. NOTE: der → den in Akkusativ!',
    rules: [
  ...
  {
    id: 5, emoji: '🔮', title: 'Modalverben', sub: 'Modal verbs',
    color: '#f39c12',
    explain: 'The modal verb goes in POSITION 2. The main verb goes to the END of the sentence as an infinitive.',
    rules: [
      ...
      { r: 'dürfen – may / to be allowed', ex: ['Darf ich rauchen?','Hier darf man nicht parken.'],          tip: 'Used for permission' },
    ],
    ex: [
  ...
  {
    id: 6, emoji: '🏗️', title: 'Satzstruktur', sub: 'German sentence structure',
    color: '#1abc9c',
    explain: 'GOLDEN RULE: The verb ALWAYS goes in POSITION 2! When an adverb starts the sentence, the subject and verb swap positions.',
    rules: [
...
// ════════════════════════════════════════
//  DATA – VERB CONJUGATIONS  (by topic)
...
function homeHtml() {
  ...
  return `
    ...
    <div class="page">
      ...
      <div class="g2">
        ${T.map(t=>`
          <button class="row-btn" style="background:${S.progress[t.id]?t.light:'#fff'};border-color:${S.progress[t.id]?t.color:'#e0e0e0'}" data-tid="${t.id}">
...
function topicsHtml() {
  return `
    <div class="page">
      <h2 style="padding-top:16px;margin-bottom:14px">📚 All 10 Topics</h2>
      <div style="display:flex;flex-direction:column;gap:10px">
        ${T.map(t=>`
          <button class="row-btn" style="padding:14px 16px;border-color:${S.progress[t.id]?t.color:'#e8e8e8'}" data-tid="${t.id}">
...
function topicDetailHtml() {
  ...
  const tabs = [
    ...
    {id:'hoeren',  l:'🎧 Listening'},
    {id:'sprechen',l:'🗣️ Speaking'},
    {id:'lesen',   l:'📖 Reading'},
    {id:'schreiben',l:'✍️ Writing'},
    {id:'quiz',    l:'🎯 Quiz'},
  ];
  return `
    <div>
...
function skillHtml(t) {
  switch (S.skill) {
    case 'vocab':     return vocabHtml(t);
    case 'hoeren':    return hoerenHtml(t);
    case 'sprechen':  return sprechenHtml(t);
    case 'lesen':     return lesenHtml(t);
    case 'schreiben': return schreibenHtml(t);
    case 'quiz':      return quizWidgetHtml(t.quiz, 't'+t.id);
    default:          return vocabHtml(t);
  }
}
...
function hoerenHtml(t) {
  return `
    <div style="background:#f8f8f8;border-radius:12px;padding:16px;margin-bottom:16px">
      ...
      <p style="font-size:12px;color:#666;margin-top:8px">💡 DW Deutsch / Goethe Institut A1. If the video is unavailable, update ytId in script.js.</p>
    </div>
...
function sprechenHtml(t) {
  ...
  return `
    <div style="background:#edfaf7;border:1px solid #1abc9c;border-radius:12px;padding:16px;margin-bottom:16px">
      ...
      ${t.speaking.map(s=>`
        <div style="background:#fff;border-radius:10px;padding:12px 14px;margin-bottom:8px;display:flex;align-items:center;gap:10px">
      ...
      ${t.reading.qs.map((q,i)=>`
        <div style="background:#fff;border-radius:8px;padding:12px;margin-bottom:10px">
          ...
          ${S.showAns[`${t.id}-${i}`]
            ...
            :`<button data-ans="${t.id}-${i}" style="font-size:12px;background:#3498db;color:#fff;border:none;border-radius:6px;padding:4px 10px;cursor:pointer">Show answer</button>`}
        </div>`).join('')}
    </div>`;
}
...
function schreibenHtml(t) {
  return `
    <div style="background:#fff8e1;border:1px solid #FFCE00;border-radius:12px;padding:16px;margin-bottom:16px">
...
function grammarHtml() {
  return `
    <div class="page">
      <h2 style="padding-top:16px;margin-bottom:4px">✏️ Grammar A1</h2>
      <p style="color:#666;font-size:13px;margin-bottom:16px">Based on Goethe Institut &amp; Prima Plus curriculum</p>
      <div style="display:flex;flex-direction:column;gap:12px">
        ${G.map(g=>`
          <button class="row-btn" style="padding:14px 16px" data-gid="${g.id}">
...
function grammarDetailHtml() {
  ...
  return `
    <div>
      ...
      <div class="page" style="padding-top:16px">
        <div style="background:#fff8e1;border:1px solid #FFCE00;border-radius:10px;padding:14px;margin-bottom:16px">
          <p style="font-size:14px;color:#555;margin:0">${esc(g.explain)}</p>
        </div>
        ${g.rules.map(r=>`
          <div class="card">
...
function quizPageHtml() {
  if (!S.quizInit) {
    ...
    S.quiz = { questions:qs, idx:0, sel:null, score:0, done:false, final:0, src:'main' };
    S.quizInit = true;
  }
  return `
    <div class="page">
...
// ════════════════════════════════════════
//  PAGE: VERB CONJUGATIONS  (accordion by topic)
// ════════════════════════════════════════
function verbsHtml() {
  if (!S.verbOpen) S.verbOpen = {};
  ...
  return `<div class="page">
    <div style="padding-top:16px;margin-bottom:16px">
      ...
      <p style="color:#666;font-size:13px;margin-bottom:10px">10 topics · Click a topic to expand · Press 🔊 to listen</p>
    ...
    ${VERBS.map(topic => {
      ...
      return `
        <div style="margin-bottom:10px;border-radius:12px;overflow:hidden;border:1.5px solid ${open ? topic.color : '#e0e0e0'}">
          ...
          <button data-verbopen="${topic.tid}" style="width:100%;background:${open ? topic.color : '#fff'};border:none;padding:14px 16px;cursor:pointer;display:flex;align-items:center;gap:12px;text-align:left">
            ...
            <span style="font-size:18px;color:${open ? '#fff' : '#bbb'};display:inline-block;transform:rotate(${open?180:0}deg);transition:transform .2s">▼</span>
          </button>

          <!-- Conjugation tables -->
          ${open ? `<div style="background:#fff;border-top:1px solid ${topic.color}33">
            ${topic.verbs.map((v, vi) => `
              <div style="padding:14px 16px;${vi < topic.verbs.length-1 ? `border-bottom:1px solid ${topic.color}22` : ''}">
                  ...
                  ${pronouns.map((pr, i) => {
                    ...
                    return `<div style="display:grid;grid-template-columns:110px 1fr 36px;background:${bg};border-bottom:${i<5?'1px solid #f0f0f0':'none'}">
                      ...
                      <div style="padding:6px 4px;display:flex;align-items:center;justify-content:center">
                        <button class="spk" data-speak="${encodeURIComponent(pr.split('/')[0].trim()+' '+form)}" style="font-size:14px">🔊</button>
                      </div>
                    </div>`;
                  }).join('')}
                </div>
...
function quizWidgetHtml(questions, src) {
  ...
  return quizInnerHtml(S.quiz.questions.length ? S.quiz.questions : questions);
}

function quizInnerHtml(questions) {
  const q = S.quiz;
  if (!q.questions.length) S.quiz.questions = questions;
  ...
  return `<div>
    ...
    ${qi.o.map((opt,i)=>{
      let cls='qopt', pre='';
      if(q.sel!==null){cls+=' off';if(i===qi.a){cls+=' ok';pre='✅ ';}else if(i===q.sel){cls+=' err';pre='❌ ';}}
      return `<button class="${cls}" data-pick="${i}">${pre}${esc(opt)}</button>`;
    }).join('')}
...
function handleClick(e) {
  const el = e.target.closest('[data-nav],[data-tid],[data-gid],[data-action],[data-skill],[data-pick],[data-ans],[data-speak]');
  if (!el) return;
  e.stopPropagation();
  ...
  if (el.dataset.verbopen !== undefined) {
    if (!S.verbOpen) S.verbOpen = {};
    const id = parseInt(el.dataset.verbopen);
    S.verbOpen[id] = !S.verbOpen[id];
    render(); return;
  }
...
function handleInput(e) {
  ...
  if (ta && ta.id && ta.id.startsWith('wr-')) {
    const id = parseInt(ta.id.slice(3));
    S.writing[id] = ta.value;
    saveWrite();
  }
}
