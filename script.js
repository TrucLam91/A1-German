...
{de:'der Wohnort (-e)',vi:'place of residence',ex:'Mein Wohnort ist Berlin.',cat:'4. Wohnort 🏠'},
...
{de:'die Postleitzahl / PLZ',vi:'postal code',ex:'Die PLZ ist 10115.',cat:'4. Wohnort 🏠'},
...
{cat:'2. Alter 🎂',items:[{q:'Wie alt sind Sie? / Wie alt bist du?',a:'Ich bin ___ Jahre alt.'},{q:'Wann sind Sie geboren?',a:'Ich bin am ___ geboren.'}]},
{cat:'3. Herkunft 🌍',items:[{q:'Woher kommen Sie? / Woher kommst du?',a:'Ich komme aus ___.'}]},
{cat:'4. Wohnort 🏠',items:[{q:'Wo wohnen Sie? / Wo wohnst du?',a:'Ich wohne in ___.'},{q:'Wie ist Ihre Adresse?',a:'Meine Adresse ist ___.'}]},
{cat:'5. Sprachen 🗣️',items:[{q:'Welche Sprachen sprechen Sie?',a:'Ich spreche ___ und ein bisschen Deutsch.'}]},
{cat:'6. Beruf 💼',items:[{q:'Was sind Sie von Beruf?',a:'Ich bin ___. / Ich arbeite als ___.'},{q:'Arbeitest oder studierst du?',a:'Ich studiere ___.'}]},
{cat:'7. Familienstand 💍',items:[{q:'Wie ist Ihr Familienstand?',a:'Ich bin ledig / verheiratet / geschieden.'}]},
...
writing:{task:'Schreib 4–6 Sätze über dich! ✍️',tmpl:'Ich heiße ___. Ich komme aus ___. Ich wohne in ___. Ich bin ___ Jahre alt. Ich bin ___ von Beruf.',ex:'Ich heiße Minh. Ich komme aus Vietnam. Ich wohne in Ho-Chi-Minh-Stadt. Ich bin 24 Jahre alt. Ich studiere Informatik. In meiner Freizeit höre ich Musik.'},
quiz:[
...
{de:'die Eltern',vi:'parents (plural only)',ex:'Meine Eltern wohnen in Hanoi.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'der Vater (Väter)',vi:'father',ex:'Mein Vater ist Ingenieur.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'die Mutter (Mütter)',vi:'mother',ex:'Meine Mutter ist Lehrerin.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'das Kind (-er)',vi:'child / children',ex:'Sie haben zwei Kinder.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'der Sohn (Söhne)',vi:'son',ex:'Mein Sohn ist 5 Jahre alt.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'die Tochter (Töchter)',vi:'daughter',ex:'Meine Tochter heißt Laura.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'der Ehemann / der Mann',vi:'husband / man',ex:'Mein Ehemann heißt Klaus.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'die Ehefrau / die Frau',vi:'wife / woman',ex:'Meine Ehefrau heißt Petra.',cat:'1. Kernfamilie 👨‍👩‍👧'},
{de:'der Partner / die Partnerin',vi:'partner',ex:'Mein Partner kommt aus Deutschland.',cat:'1. Kernfamilie 👨‍👩‍👧'},
// 2. Geschwister und Verwandte
{de:'die Geschwister',vi:'siblings (plural only)',ex:'Ich habe zwei Geschwister.',cat:'2. Geschwister & Verwandte 👫'},
{de:'der Bruder (Brüder)',vi:'brother',ex:'Mein Bruder studiert in Berlin.',cat:'2. Geschwister & Verwandte 👫'},
{de:'die Schwester (-n)',vi:'sister',ex:'Meine Schwester heißt Lisa.',cat:'2. Geschwister & Verwandte 👫'},
{de:'der Verwandte (-n)',vi:'relative',ex:'Er ist ein Verwandter.',cat:'2. Geschwister & Verwandte 👫'},
{de:'der Onkel (-)',vi:'uncle',ex:'Mein Onkel wohnt in Hamburg.',cat:'2. Geschwister & Verwandte 👫'},
{de:'die Tante (-n)',vi:'aunt',ex:'Meine Tante kocht sehr gut.',cat:'2. Geschwister & Verwandte 👫'},
{de:'der Cousin (-s)',vi:'male cousin',ex:'Mein Cousin ist 20 Jahre alt.',cat:'2. Geschwister & Verwandte 👫'},
{de:'die Cousine (-n)',vi:'female cousin',ex:'Meine Cousine wohnt in München.',cat:'2. Geschwister & Verwandte 👫'},
// 3. Großeltern und Enkel
{de:'die Großeltern',vi:'grandparents (plural only)',ex:'Meine Großeltern wohnen in Bayern.',cat:'3. Großeltern & Enkel 👴👵'},
{de:'der Großvater / der Opa',vi:'grandfather / grandpa',ex:'Mein Opa ist 70 Jahre alt.',cat:'3. Großeltern & Enkel 👴👵'},
{de:'die Großmutter / die Oma',vi:'grandmother / grandma',ex:'Meine Oma kocht sehr gut.',cat:'3. Großeltern & Enkel 👴👵'},
{de:'der Enkel (-)',vi:'grandson (of grandparents)',ex:'Der Enkel spielt im Garten.',cat:'3. Großeltern & Enkel 👴👵'},
{de:'die Enkelin (-nen)',vi:'granddaughter',ex:'Die Enkelin ist sehr süß.',cat:'3. Großeltern & Enkel 👴👵'},
// 4. Familienstand
{de:'der Familienstand',vi:'marital status',ex:'Wie ist Ihr Familienstand?',cat:'4. Familienstand 💍'},
{de:'ledig / Single',vi:'single',ex:'Ich bin noch ledig.',cat:'4. Familienstand 💍'},
{de:'verheiratet',vi:'married',ex:'Meine Eltern sind verheiratet.',cat:'4. Familienstand 💍'},
{de:'geschieden',vi:'divorced',ex:'Er ist geschieden.',cat:'4. Familienstand 💍'},
{de:'getrennt',vi:'separated',ex:'Sie leben getrennt.',cat:'4. Familienstand 💍'},
...
speakGroups:[
{cat:'1. Über die Familie 👨‍👩‍👧',items:[
{q:'Wie ist Ihr Familienstand?',a:'Ich bin ledig / verheiratet / geschieden.'},
{q:'Bist du ledig oder verheiratet?',a:'Ich bin ___.'},
{q:'Hast du Kinder?',a:'Ja, ich habe ___ Kind(er). / Nein, ich habe keine Kinder.'},
{q:'Wie viele Kinder hast du?',a:'Ich habe ___ Kinder. Sie heißen ___ und ___.'},
{q:'Wie alt sind deine Kinder?',a:'Mein Sohn / Meine Tochter ist ___ Jahre alt.'},
]},
{cat:'2. Geschwister & Verwandte 👫',items:[
{q:'Hast du Geschwister?',a:'Ja, ich habe ___ Bruder / Schwester. / Nein, ich bin Einzelkind.'},
{q:'Wie heißt dein Bruder / deine Schwester?',a:'Mein Bruder / Meine Schwester heißt ___.'},
{q:'Wohnst du allein?',a:'Ja, ich wohne allein. / Nein, ich wohne mit meiner Familie.'},
{q:'Hast du ein Haustier?',a:'Ja, ich habe einen Hund / eine Katze. / Nein, ich habe kein Haustier.'},
]},
],
writing:{task:'Beschreib deine Familie! ✍️',tmpl:'Meine Familie hat ___ Personen. Mein Vater heißt ___. Meine Mutter heißt ___. Ich habe ___ Geschwister.',ex:'Meine Familie hat 4 Personen. Mein Vater heißt Minh. Er ist Ingenieur. Meine Mutter heißt Lan. Sie ist Lehrerin. Ich habe eine Schwester. Sie heißt Hoa und ist 19 Jahre alt. Meine Großeltern wohnen in Hanoi. Wir besuchen sie oft.'},
quiz:[
{q:'What is the German word for "mother"?',o:['Vater','Bruder','Mutter','Schwester'],a:2},
{q:'Possessive (masculine): ___ Vater',o:['mein','meine','meinen','meiner'],a:0},
{q:'Possessive (feminine): ___ Mutter',o:['mein','meine','meinen','meiner'],a:1},
...
{de:'zwei',vi:'two',ex:'Ich kaufe zwei Äpfel.',cat:'1. Zahlen 1–20 🔢'},
{de:'drei',vi:'three',ex:'Wir brauchen noch drei Gläser.',cat:'1. Zahlen 1–20 🔢'},
{de:'vier',vi:'four',ex:'Vier Grad über Null.',cat:'1. Zahlen 1–20 🔢'},
{de:'fünf',vi:'five',ex:'Der Eintritt kostet 5 Euro.',cat:'1. Zahlen 1–20 🔢'},
{de:'sechs',vi:'six',ex:'Es ist Viertel nach sechs.',cat:'1. Zahlen 1–20 🔢'},
{de:'sieben',vi:'seven',ex:'Er kommt um sieben Uhr.',cat:'1. Zahlen 1–20 🔢'},
{de:'acht',vi:'eight',ex:'Mein Sohn ist acht Jahre alt.',cat:'1. Zahlen 1–20 🔢'},
{de:'neun',vi:'nine',ex:'Es ist neun Uhr.',cat:'1. Zahlen 1–20 🔢'},
{de:'zehn',vi:'ten',ex:'Zehn Minuten hast du noch.',cat:'1. Zahlen 1–20 🔢'},
{de:'elf',vi:'eleven',ex:'Meine Tochter ist elf Jahre alt.',cat:'1. Zahlen 1–20 🔢'},
{de:'zwölf',vi:'twelve',ex:'Sie haben Zimmer Nummer zwölf.',cat:'1. Zahlen 1–20 🔢'},
{de:'dreizehn',vi:'thirteen',ex:'Dreizehn Uhr siebzehn.',cat:'1. Zahlen 1–20 🔢'},
{de:'vierzehn',vi:'fourteen',ex:'Wir sind 14 Jahre alt.',cat:'1. Zahlen 1–20 🔢'},
{de:'fünfzehn',vi:'fifteen',ex:'Es darf nicht mehr als 15 Euro kosten.',cat:'1. Zahlen 1–20 🔢'},
{de:'sechzehn',vi:'sixteen',ex:'Ich bin sechzehn Jahre alt.',cat:'1. Zahlen 1–20 🔢'},
{de:'siebzehn',vi:'seventeen',ex:'Er ist siebzehn.',cat:'1. Zahlen 1–20 🔢'},
{de:'achtzehn',vi:'eighteen',ex:'Sind Sie über 18?',cat:'1. Zahlen 1–20 🔢'},
{de:'neunzehn',vi:'nineteen',ex:'Neunzehn Euro.',cat:'1. Zahlen 1–20 🔢'},
{de:'zwanzig',vi:'twenty',ex:'In unserer Klasse sind 25 Schüler.',cat:'1. Zahlen 1–20 🔢'},
// 2. Zahlen 21–1000
{de:'einundzwanzig',vi:'twenty-one',ex:'Claudia ist 21.',cat:'2. Zahlen 21–1000 🔢'},
{de:'dreißig',vi:'thirty',ex:'Heute haben wir dreißig Grad.',cat:'2. Zahlen 21–1000 🔢'},
{de:'vierzig',vi:'forty',ex:'Haben Sie das auch in Größe 40?',cat:'2. Zahlen 21–1000 🔢'},
{de:'fünfzig',vi:'fifty',ex:'Er hat fünfzig Euro.',cat:'2. Zahlen 21–1000 🔢'},
{de:'sechzig',vi:'sixty',ex:'Von Mainz nach Frankfurt sind es ca. 60 km.',cat:'2. Zahlen 21–1000 🔢'},
{de:'siebzig',vi:'seventy',ex:'Mein Opa ist siebzig.',cat:'2. Zahlen 21–1000 🔢'},
{de:'achtzig',vi:'eighty',ex:'Mein Großvater ist schon 80.',cat:'2. Zahlen 21–1000 🔢'},
{de:'neunzig',vi:'ninety',ex:'Fünfundneunzig Euro.',cat:'2. Zahlen 21–1000 🔢'},
{de:'hundert',vi:'one hundred',ex:'Das kostet hundert Euro.',cat:'2. Zahlen 21–1000 🔢'},
{de:'hunderteins',vi:'one hundred and one',ex:'Zimmer hunderteins.',cat:'2. Zahlen 21–1000 🔢'},
{de:'zweihundert',vi:'two hundred',ex:'Zweihundert Kilometer.',cat:'2. Zahlen 21–1000 🔢'},
{de:'tausend',vi:'one thousand',ex:'Hat dein Haus auch tausend Zimmer?',cat:'2. Zahlen 21–1000 🔢'},
// 3. Ordnungszahlen
{de:'erste',vi:'first',ex:'Heute ist der erste März.',cat:'3. Ordnungszahlen 📍'},
{de:'zweite',vi:'second',ex:'Lies bitte auch den zweiten Teil.',cat:'3. Ordnungszahlen 📍'},
{de:'dritte',vi:'third',ex:'Heute ist der dritte April.',cat:'3. Ordnungszahlen 📍'},
// 4. Wochentage
{de:'der Wochentag (-e)',vi:'day of the week',ex:'Welcher Wochentag ist heute?',cat:'4. Wochentage 📅'},
{de:'der Montag',vi:'Monday',ex:'Am Montag ist Feiertag.',cat:'4. Wochentage 📅'},
{de:'der Dienstag',vi:'Tuesday',ex:'Meine Schwester kommt am Dienstag.',cat:'4. Wochentage 📅'},
{de:'der Mittwoch',vi:'Wednesday',ex:'Am Mittwoch hast du Schule.',cat:'4. Wochentage 📅'},
{de:'der Donnerstag',vi:'Thursday',ex:'Am Donnerstag gehe ich einkaufen.',cat:'4. Wochentage 📅'},
{de:'der Freitag',vi:'Friday',ex:'Die Party ist am Freitag.',cat:'4. Wochentage 📅'},
{de:'der Samstag / der Sonnabend',vi:'Saturday',ex:'Die Bank hat am Samstag geschlossen.',cat:'4. Wochentage 📅'},
{de:'der Sonntag',vi:'Sunday',ex:'Am Sonntag frühstücke ich gern im Bett.',cat:'4. Wochentage 📅'},
{de:'das Wochenende (-n)',vi:'weekend',ex:'Am Wochenende haben wir viele Gäste.',cat:'4. Wochentage 📅'},
// 5. Monate
{de:'der Januar',vi:'January',ex:'Im Januar ist es kalt.',cat:'5. Monate 🗓️'},
{de:'der Februar',vi:'February',ex:'Der Februar hat 28 Tage.',cat:'5. Monate 🗓️'},
{de:'der März',vi:'March',ex:'Heute ist der erste März.',cat:'5. Monate 🗓️'},
{de:'der April',vi:'April',ex:'Berlin, 12. April 2002.',cat:'5. Monate 🗓️'},
{de:'der Mai',vi:'May',ex:'Der erste Mai ist ein Feiertag.',cat:'5. Monate 🗓️'},
{de:'der Juni',vi:'June',ex:'Der Sommer beginnt im Juni.',cat:'5. Monate 🗓️'},
{de:'der Juli',vi:'July',ex:'Wir machen Anfang Juli Urlaub.',cat:'5. Monate 🗓️'},
{de:'der August',vi:'August',ex:'Ich komme im August nach Dresden.',cat:'5. Monate 🗓️'},
{de:'der September',vi:'September',ex:'Ich nehme im September Urlaub.',cat:'5. Monate 🗓️'},
{de:'der Oktober',vi:'October',ex:'Das Studium beginnt im Oktober.',cat:'5. Monate 🗓️'},
{de:'der November',vi:'November',ex:'Im November regnet es oft.',cat:'5. Monate 🗓️'},
{de:'der Dezember',vi:'December',ex:'Weihnachten ist im Dezember.',cat:'5. Monate 🗓️'},
// 6. Jahreszeiten
{de:'der Frühling / das Frühjahr',vi:'spring',ex:'Der Frühling ist eine schöne Jahreszeit.',cat:'6. Jahreszeiten 🌸'},
{de:'der Sommer (-)',vi:'summer',ex:'Im Sommer ist es bis 21 Uhr hell.',cat:'6. Jahreszeiten 🌸'},
{de:'der Herbst (-e)',vi:'autumn',ex:'Im Herbst fallen die Blätter.',cat:'6. Jahreszeiten 🌸'},
{de:'der Winter (-)',vi:'winter',ex:'Im Winter fahre ich Ski.',cat:'6. Jahreszeiten 🌸'},
// 7. Datum & Jahreszahlen
{de:'der Geburtstag (-e)',vi:'birthday',ex:'Wann ist dein Geburtstag?',cat:'7. Datum & Jahr 📆'},
{de:'das Jahr (-e)',vi:'year',ex:'Das Jahr hat 365 Tage.',cat:'7. Datum & Jahr 📆'},
...
vocab:[
// 1. Getränke
{de:'das Wasser (-)',vi:'water',ex:'Ein Wasser, bitte!',cat:'1. Getränke 🥤'},
{de:'der Kaffee (-s)',vi:'coffee',ex:'Ich trinke gern Kaffee.',cat:'1. Getränke 🥤'},
{de:'der Tee (-s)',vi:'tea',ex:'Ich trinke morgens immer Tee.',cat:'1. Getränke 🥤'},
{de:'der Saft (Säfte)',vi:'juice',ex:'Möchtest du einen Apfelsaft?',cat:'1. Getränke 🥤'},
{de:'die Milch',vi:'milk',ex:'Die Milch steht im Kühlschrank.',cat:'1. Getränke 🥤'},
{de:'das Bier (-e)',vi:'beer',ex:'Noch ein Bier, bitte.',cat:'1. Getränke 🥤'},
{de:'der Wein (-e)',vi:'wine',ex:'Nein danke, ich möchte keinen Wein.',cat:'1. Getränke 🥤'},
// 2. Brot & Frühstück
{de:'das Brot (-e)',vi:'bread',ex:'Ich esse Brot zum Frühstück.',cat:'2. Brot & Frühstück 🥐'},
{de:'das Brötchen (-)',vi:'bread roll',ex:'Ein Brötchen mit Butter und Käse.',cat:'2. Brot & Frühstück 🥐'},
{de:'die Butter',vi:'butter',ex:'Ich esse Brot mit Butter.',cat:'2. Brot & Frühstück 🥐'},
{de:'die Marmelade (-n)',vi:'jam',ex:'Ich esse Brötchen mit Butter und Marmelade.',cat:'2. Brot & Frühstück 🥐'},
{de:'der Käse (-)',vi:'cheese',ex:'Für mich bitte ein Brötchen mit Käse.',cat:'2. Brot & Frühstück 🥐'},
{de:'die Wurst (Würste)',vi:'sausage',ex:'Ich esse lieber Wurst als Käse.',cat:'2. Brot & Frühstück 🥐'},
{de:'das Ei (-er)',vi:'egg',ex:'Möchtest du ein Ei zum Frühstück?',cat:'2. Brot & Frühstück 🥐'},
{de:'der Joghurt (-s)',vi:'yogurt',ex:'Ich esse sehr gern Joghurt.',cat:'2. Brot & Frühstück 🥐'},
{de:'das Müsli (-s)',vi:'muesli / cereal',ex:'Er isst lieber Brot als Müsli.',cat:'2. Brot & Frühstück 🥐'},
// 3. Obst & Gemüse
{de:'das Obst',vi:'fruit (collective)',ex:'Im Sommer ist das Obst billig.',cat:'3. Obst & Gemüse 🥦'},
{de:'der Apfel (Äpfel)',vi:'apple',ex:'Ein Kilo Äpfel, bitte!',cat:'3. Obst & Gemüse 🥦'},
{de:'die Banane (-n)',vi:'banana',ex:'Drei Bananen, bitte!',cat:'3. Obst & Gemüse 🥦'},
{de:'die Tomate (-n)',vi:'tomato',ex:'Die Tomate ist noch grün.',cat:'3. Obst & Gemüse 🥦'},
{de:'die Kartoffel (-n)',vi:'potato',ex:'Für Pommes frites braucht man Kartoffeln.',cat:'3. Obst & Gemüse 🥦'},
{de:'der Salat (-e)',vi:'salad / lettuce',ex:'Wie schmeckt dir der Salat?',cat:'3. Obst & Gemüse 🥦'},
{de:'die Zwiebel (-n)',vi:'onion',ex:'Ich brauche Zwiebeln für den Salat.',cat:'3. Obst & Gemüse 🥦'},
{de:'die Möhre (-n)',vi:'carrot',ex:'Ich esse am liebsten Möhren.',cat:'3. Obst & Gemüse 🥦'},
{de:'die Gurke (-n)',vi:'cucumber',ex:'Wir kaufen Tomaten und Gurken.',cat:'3. Obst & Gemüse 🥦'},
// 4. Hauptgerichte
{de:'das Fleisch',vi:'meat',ex:'Ich esse kein Fleisch.',cat:'4. Hauptgerichte 🍽️'},
{de:'der Fisch (-e)',vi:'fish',ex:'Fleisch esse ich nicht, ich esse gerne Fisch.',cat:'4. Hauptgerichte 🍽️'},
{de:'das Hähnchen (-)',vi:'chicken',ex:'Ein Hähnchen mit Pommes bitte!',cat:'4. Hauptgerichte 🍽️'},
{de:'die Nudel (-n)',vi:'noodle / pasta',ex:'Ich esse oft Reis oder Nudeln.',cat:'4. Hauptgerichte 🍽️'},
{de:'der Reis',vi:'rice',ex:'Ich esse gern Reis.',cat:'4. Hauptgerichte 🍽️'},
{de:'die Suppe (-n)',vi:'soup',ex:'Ich esse gerne Suppe zum Abendessen.',cat:'4. Hauptgerichte 🍽️'},
{de:'das Gemüse',vi:'vegetables',ex:'Ich esse viel Gemüse.',cat:'4. Hauptgerichte 🍽️'},
// 5. Süßigkeiten & Dessert
{de:'das Eis',vi:'ice cream',ex:'Möchtest du ein Eis?',cat:'5. Dessert & Süßes 🍰'},
{de:'der Kuchen (-)',vi:'cake',ex:'Ich nehme ein Stück Kuchen.',cat:'5. Dessert & Süßes 🍰'},
// 6. Würzen & Zutaten
{de:'das Salz',vi:'salt',ex:'Kann ich bitte Salz haben?',cat:'6. Zutaten & Würzen 🧂'},
{de:'der Zucker (-)',vi:'sugar',ex:'Trinken Sie den Kaffee mit Zucker?',cat:'6. Zutaten & Würzen 🧂'},
// 7. Mahlzeiten
{de:'das Frühstück',vi:'breakfast',ex:'Was isst du zum Frühstück?',cat:'7. Mahlzeiten 🕐'},
{de:'das Mittagessen (-)',vi:'lunch',ex:'Was essen Deutsche zum Mittagessen?',cat:'7. Mahlzeiten 🕐'},
{de:'das Abendessen (-)',vi:'dinner',ex:'Was isst du am liebsten zum Abendessen?',cat:'7. Mahlzeiten 🕐'},
{de:'der Hunger',vi:'hunger',ex:'Ich habe Hunger! Wann ist das Essen fertig?',cat:'7. Mahlzeiten 🕐'},
{de:'der Durst',vi:'thirst',ex:'Hast du etwas zu trinken? Ich habe großen Durst.',cat:'7. Mahlzeiten 🕐'},
// 8. Restaurant & Bestellungen
{de:'die Speisekarte (-n)',vi:'menu',ex:'Die Speisekarte, bitte!',cat:'8. Restaurant 🍽️'},
{de:'möchten',vi:'to want (polite)',ex:'Ich möchte ein Schnitzel.',cat:'8. Restaurant 🍽️'},
{de:'kosten',vi:'to cost',ex:'Was kostet das?',cat:'8. Restaurant 🍽️'},
{de:'lecker',vi:'delicious',ex:'Das Essen ist sehr lecker!',cat:'8. Restaurant 🍽️'},
{de:'die Rechnung (-en)',vi:'bill / check',ex:'Die Rechnung, bitte!',cat:'8. Restaurant 🍽️'},
// 9. Geschmack
{de:'süß',vi:'sweet',ex:'Cola ist mir zu süß.',cat:'9. Geschmack 😋'},
{de:'scharf',vi:'spicy',ex:'Das Essen ist sehr scharf.',cat:'9. Geschmack 😋'},
{de:'sauer',vi:'sour',ex:'Der Apfelsaft ist zu sauer.',cat:'9. Geschmack 😋'},
{de:'salzig',vi:'salty',ex:'Die Suppe ist sehr salzig.',cat:'9. Geschmack 😋'},
{de:'bitter',vi:'bitter',ex:'Der Kaffee schmeckt bitter.',cat:'9. Geschmack 😋'},
],
...
vocab:[
// 1. Wohnformen
{de:'die Wohnung (-en)',vi:'apartment',ex:'Seit wann haben Sie diese Wohnung?',cat:'1. Wohnformen 🏠'},
{de:'das Haus (Häuser)',vi:'house',ex:'In welchem Haus wohnst du?',cat:'1. Wohnformen 🏠'},
{de:'das Erdgeschoss',vi:'ground floor',ex:'Unsere Wohnung liegt im Erdgeschoss.',cat:'1. Wohnformen 🏠'},
{de:'der Keller (-)',vi:'basement',ex:'Die Waschmaschine steht im Keller.',cat:'1. Wohnformen 🏠'},
{de:'der Garten (Gärten)',vi:'garden',ex:'Wir haben leider keinen Garten.',cat:'1. Wohnformen 🏠'},
{de:'die Garage (-n)',vi:'garage',ex:'Das Auto steht in der Garage.',cat:'1. Wohnformen 🏠'},
{de:'der Balkon (-s)',vi:'balcony',ex:'Die Wohnung hat auch einen kleinen Balkon.',cat:'1. Wohnformen 🏠'},
// 2. Zimmer & Räume
{de:'das Zimmer (-)',vi:'room',ex:'Die Wohnung hat drei Zimmer.',cat:'2. Zimmer & Räume 🚪'},
{de:'das Wohnzimmer (-)',vi:'living room',ex:'Im Wohnzimmer steht ein neues Sofa.',cat:'2. Zimmer & Räume 🚪'},
{de:'das Schlafzimmer (-)',vi:'bedroom',ex:'Öffne im Schlafzimmer das Fenster, bitte!',cat:'2. Zimmer & Räume 🚪'},
{de:'das Badezimmer / das Bad',vi:'bathroom',ex:'Wir haben kein großes Bad.',cat:'2. Zimmer & Räume 🚪'},
{de:'die Küche (-n)',vi:'kitchen',ex:'Der neue Herd kommt in die Küche.',cat:'2. Zimmer & Räume 🚪'},
{de:'der Flur (-e)',vi:'hallway / corridor',ex:'Der Flur in meiner Wohnung ist sehr schmal.',cat:'2. Zimmer & Räume 🚪'},
// 3. Wände, Boden & Bauteile
{de:'das Fenster (-)',vi:'window',ex:'Das Fenster ist noch auf.',cat:'3. Bauteile 🪟'},
{de:'die Tür (-en)',vi:'door',ex:'Bitte, schließen Sie die Tür.',cat:'3. Bauteile 🪟'},
{de:'die Wand (Wände)',vi:'wall',ex:'Der Schrank steht an der Wand.',cat:'3. Bauteile 🪟'},
{de:'der Boden (Böden)',vi:'floor',ex:'Ein Teppich liegt auf dem Boden.',cat:'3. Bauteile 🪟'},
{de:'die Decke (-n)',vi:'ceiling',ex:'Die Lampe hängt an der Decke.',cat:'3. Bauteile 🪟'},
// 4. Miete & Kosten
{de:'mieten',vi:'to rent',ex:'Ich möchte ein Auto mieten.',cat:'4. Miete & Kosten 💶'},
{de:'die Miete (-n)',vi:'rent',ex:'Die Miete für diese Wohnung ist 600 Euro.',cat:'4. Miete & Kosten 💶'},
{de:'die Monatsmiete (-n)',vi:'monthly rent',ex:'Die Monatsmiete kostet 1.200 Euro.',cat:'4. Miete & Kosten 💶'},
{de:'die Nebenkosten',vi:'utilities / additional costs',ex:'Die Miete ist 600 Euro plus Nebenkosten.',cat:'4. Miete & Kosten 💶'},
{de:'die Kaution (-en)',vi:'deposit',ex:'Wie hoch ist die Kaution?',cat:'4. Miete & Kosten 💶'},
{de:'der Vermieter (-)',vi:'landlord',ex:'Unser Vermieter heißt Huber.',cat:'4. Miete & Kosten 💶'},
{de:'möbliert',vi:'furnished',ex:'Ich suche eine möblierte Wohnung.',cat:'4. Miete & Kosten 💶'},
{de:'der Strom',vi:'electricity',ex:'Der Strom ist sehr teuer.',cat:'4. Miete & Kosten 💶'},
{de:'die Heizung (-en)',vi:'heating',ex:'Die Heizung ist kaputt.',cat:'4. Miete & Kosten 💶'},
// 5. Möbel & Einrichtung
{de:'die Möbel',vi:'furniture (plural)',ex:'Sind die Möbel neu?',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Tisch (-e)',vi:'table',ex:'Die Fotos liegen auf dem Tisch.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Schreibtisch (-e)',vi:'desk',ex:'Im Arbeitszimmer steht mein Schreibtisch.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Stuhl (Stühle)',vi:'chair',ex:'Der Stuhl ist sehr bequem.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'das Bett (-en)',vi:'bed',ex:'Wir brauchen noch ein Kinderbett.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Schrank (Schränke)',vi:'wardrobe / closet',ex:'Die Gläser stehen im Schrank.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'das Sofa / die Couch',vi:'sofa / couch',ex:'Das Sofa ist neu.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Sessel (-)',vi:'armchair',ex:'Neben dem Schreibtisch steht mein Sessel.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'das Regal (-e)',vi:'shelf',ex:'Die Bücher stehen im Regal.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'der Teppich (-e)',vi:'carpet / rug',ex:'Wir haben einen neuen Teppich.',cat:'5. Möbel & Einrichtung 🛋️'},
{de:'die Lampe (-n)',vi:'lamp',ex:'Die Lampe ist sehr hell.',cat:'5. Möbel & Einrichtung 🛋️'},
// 6. Haushaltsgeräte
{de:'der Fernseher (-)',vi:'television',ex:'Hat Mia einen Fernseher im Zimmer?',cat:'6. Haushaltsgeräte 📺'},
{de:'der Herd (-e)',vi:'stove / cooker',ex:'In der neuen Küche fehlt noch der Herd.',cat:'6. Haushaltsgeräte 📺'},
{de:'der Kühlschrank (Kühlschränke)',vi:'refrigerator',ex:'Die Milch steht im Kühlschrank.',cat:'6. Haushaltsgeräte 📺'},
{de:'die Waschmaschine (-n)',vi:'washing machine',ex:'Die Waschmaschine ist günstig.',cat:'6. Haushaltsgeräte 📺'},
{de:'die Spülmaschine (-n)',vi:'dishwasher',ex:'Wir brauchen eine neue Spülmaschine.',cat:'6. Haushaltsgeräte 📺'},
// 7. Adjektive
{de:'hell',vi:'bright',ex:'Im Sommer ist es bis 21 Uhr hell.',cat:'7. Adjektive 💡'},
{de:'dunkel',vi:'dark',ex:'Das Zimmer ist leider sehr dunkel.',cat:'7. Adjektive 💡'},
{de:'gemütlich',vi:'cozy / comfortable',ex:'Mein Zimmer ist klein, aber sehr gemütlich.',cat:'7. Adjektive 💡'},
{de:'ordentlich',vi:'tidy / neat',ex:'Sein Zimmer ist immer sehr ordentlich.',cat:'7. Adjektive 💡'},
{de:'laut',vi:'loud',ex:'Nicht so laut! Das Baby schläft.',cat:'7. Adjektive 💡'},
{de:'ruhig',vi:'quiet',ex:'Ich möchte ein ruhiges Zimmer.',cat:'7. Adjektive 💡'},
{de:'groß / klein',vi:'big / small',ex:'Die Wohnung ist groß.',cat:'7. Adjektive 💡'},
],
reading:{title:'Luises neue Wohnung 🏡',
text:'Anna: Hallo Dave! Wie geht es dir? Wohnst du jetzt in München?\nDave: Hallo Anna! Ja, endlich! Ich habe eine neue Wohnung in der Schillerstraße. Sie ist wirklich toll und sehr hell.\nAnna: Super! Wie groß ist die Wohnung denn?\nDave: Sie ist nicht groß. Ich habe ein Wohnzimmer, ein Schlafzimmer und ein Arbeitszimmer. Es gibt auch eine schöne Küche, ein Bad.\nAnna: Deine Wohnung ist sehr gemütlich. Hast du auch neue Möbel?\nDave: Ja, im Wohnzimmer steht ein neues Sofa. Und im Arbeitszimmer steht mein Schreibtisch mit dem Computer.\nAnna: Und wie viel kostet die Wohnung?\nDave: Die Monatsmiete kostet 1.200 Euro. Das ist nicht billig, aber die Wohnung liegt im Stadtzentrum und ist sehr ruhig.',
...
rules:[
{r:'können – can',ex:['Ich kann Deutsch sprechen.'],tip:'Ability / skill'},
{r:'müssen – must',ex:['Ich muss arbeiten.'],tip:'Obligation / necessity'},
{r:'möchten – would like',ex:['Ich möchte ein Bier.'],tip:'Polite wish'},
{r:'dürfen – may',ex:['Darf ich rauchen?'],tip:'Permission'},
],
ex:[
...
rules:[
{r:'Normal: Subject → Verb → ...',ex:['Ich lerne Deutsch. ✅'],tip:'Verb in position 2'},
...
{inf:'kommen',en:'to come (from)',type:'regular',conj:{ich:'komme',du:'kommst',er:'kommt',wir:'kommen',ihr:'kommt',sie:'kommen'}},
...
{inf:'studieren',en:'to study (at uni)',type:'regular',conj:{ich:'studiere',du:'studierst',er:'studiert',wir:'studieren',ihr:'studiert',sie:'studieren'}},
{inf:'arbeiten',en:'to work',type:'regular',conj:{ich:'arbeite',du:'arbeitest',er:'arbeitet',wir:'arbeiten',ihr:'arbeitet',sie:'arbeiten'}},
{inf:'lernen',en:'to learn',type:'regular',conj:{ich:'lerne',du:'lernst',er:'lernt',wir:'lernen',ihr:'lernt',sie:'lernen'}},
{inf:'buchstabieren',en:'to spell',type:'regular',conj:{ich:'buchstabiere',du:'buchstabierst',er:'buchstabiert',wir:'buchstabieren',ihr:'buchstabiert',sie:'buchstabieren'}},
]},
...
{inf:'arbeiten',en:'to work',type:'regular',conj:{ich:'arbeite',du:'arbeitest',er:'arbeitet',wir:'arbeiten',ihr:'arbeitet',sie:'arbeiten'}},
{inf:'heiraten',en:'to get married',type:'regular',conj:{ich:'heirate',du:'heiratest',er:'heiratet',wir:'heiraten',ihr:'heiratet',sie:'heiraten'}},
{inf:'leben',en:'to live / reside',type:'regular',conj:{ich:'lebe',du:'lebst',er:'lebt',wir:'leben',ihr:'lebt',sie:'leben'}},
{inf:'besuchen',en:'to visit',type:'regular',conj:{ich:'besuche',du:'besuchst',er:'besucht',wir:'besuchen',ihr:'besucht',sie:'besuchen'}},
...
{inf:'werden',en:'to become / turn (age)',type:'irregular',
conj:{ich:'werde',du:'wirst',er:'wird',wir:'werden',ihr:'werdet',sie:'werden'}},
{inf:'zählen',en:'to count',type:'regular',
conj:{ich:'zähle',du:'zählst',er:'zählt',wir:'zählen',ihr:'zählt',sie:'zählen'}},
{inf:'rechnen',en:'to calculate',type:'regular',
conj:{ich:'rechne',du:'rechnest',er:'rechnet',wir:'rechnen',ihr:'rechnet',sie:'rechnen'}},
{inf:'bezahlen',en:'to pay',type:'regular',
conj:{ich:'bezahle',du:'bezahlst',er:'bezahlt',wir:'bezahlen',ihr:'bezahlt',sie:'bezahlen'}},
{inf:'dauern',en:'to last / to take (time)',type:'regular',
conj:{ich:'dauere',du:'dauerst',er:'dauert',wir:'dauern',ihr:'dauert',sie:'dauern'}},
{inf:'beginnen',en:'to begin / start',type:'irregular',
conj:{ich:'beginne',du:'beginnst',er:'beginnt',wir:'beginnen',ihr:'beginnt',sie:'beginnen'}},
{inf:'enden',en:'to end',type:'regular',
conj:{ich:'ende',du:'endest',er:'endet',wir:'enden',ihr:'endet',sie:'enden'}},
]},
...
{inf:'möchten',en:'would like',type:'modal',
conj:{ich:'möchte',du:'möchtest',er:'möchte',wir:'möchten',ihr:'möchtet',sie:'möchten'}},
{inf:'schmecken',en:'to taste',type:'regular',
conj:{ich:'schmecke',du:'schmeckst',er:'schmeckt',wir:'schmecken',ihr:'schmeckt',sie:'schmecken'}},
{inf:'mögen',en:'to like (food)',type:'irregular',
conj:{ich:'mag',du:'magst',er:'mag',wir:'mögen',ihr:'mögt',sie:'mögen'}},
{inf:'bestellen',en:'to order (food)',type:'regular',
conj:{ich:'bestelle',du:'bestellst',er:'bestellt',wir:'bestellen',ihr:'bestellt',sie:'bestellen'}},
{inf:'empfehlen',en:'to recommend',type:'irregular (ie)',
conj:{ich:'empfehle',du:'empfiehlst',er:'empfiehlt',wir:'empfehlen',ihr:'empfehlt',sie:'empfehlen'}},
{inf:'bezahlen',en:'to pay',type:'regular',
conj:{ich:'bezahle',du:'bezahlst',er:'bezahlt',wir:'bezahlen',ihr:'bezahlt',sie:'bezahlen'}},
]},
{tid:5,emoji:'🏠',title:'Wohnen',color:'#1abc9c',light:'#edfaf7',verbs:[
{inf:'wohnen',en:'to live / reside',type:'regular',conj:{ich:'wohne',du:'wohnst',er:'wohnt',wir:'wohnen',ihr:'wohnt',sie:'wohnen'}},
{inf:'leben',en:'to live (in general)',type:'regular',conj:{ich:'lebe',du:'lebst',er:'lebt',wir:'leben',ihr:'lebt',sie:'leben'}},
{inf:'mieten',en:'to rent',type:'regular',conj:{ich:'miete',du:'mietest',er:'mietet',wir:'mieten',ihr:'mietet',sie:'mieten'}},
{inf:'suchen',en:'to look for',type:'regular',conj:{ich:'suche',du:'suchst',er:'sucht',wir:'suchen',ihr:'sucht',sie:'suchen'}},
{inf:'finden',en:'to find',type:'irregular',conj:{ich:'finde',du:'findest',er:'findet',wir:'finden',ihr:'findet',sie:'finden'}},
{inf:'kosten',en:'to cost',type:'regular',conj:{ich:'koste',du:'kostest',er:'kostet',wir:'kosten',ihr:'kostet',sie:'kosten'}},
{inf:'haben',en:'to have',type:'irregular',conj:{ich:'habe',du:'hast',er:'hat',wir:'haben',ihr:'habt',sie:'haben'}},
{inf:'sein',en:'to be',type:'irregular',conj:{ich:'bin',du:'bist',er:'ist',wir:'sind',ihr:'seid',sie:'sind'}},
{inf:'stehen',en:'to stand / be located',type:'regular',conj:{ich:'stehe',du:'stehst',er:'steht',wir:'stehen',ihr:'steht',sie:'stehen'}},
{inf:'liegen',en:'to lie / be situated',type:'irregular',conj:{ich:'liege',du:'liegst',er:'liegt',wir:'liegen',ihr:'liegt',sie:'liegen'}},
{inf:'hängen',en:'to hang',type:'regular',conj:{ich:'hänge',du:'hängst',er:'hängt',wir:'hängen',ihr:'hängt',sie:'hängen'}},
{inf:'öffnen',en:'to open',type:'regular',conj:{ich:'öffne',du:'öffnest',er:'öffnet',wir:'öffnen',ihr:'öffnet',sie:'öffnen'}},
{inf:'schließen',en:'to close',type:'regular',conj:{ich:'schließe',du:'schließt',er:'schließt',wir:'schließen',ihr:'schließt',sie:'schließen'}},
{inf:'einziehen',en:'to move in',type:'separable',conj:{ich:'ziehe ein',du:'ziehst ein',er:'zieht ein',wir:'ziehen ein',ihr:'zieht ein',sie:'ziehen ein'}},
{inf:'ausziehen',en:'to move out',type:'separable',conj:{ich:'ziehe aus',du:'ziehst aus',er:'zieht aus',wir:'ziehen aus',ihr:'zieht aus',sie:'ziehen aus'}},
]},
...
try{var _p=localStorage.getItem('da1p');if(_p)S.progress=JSON.parse(_p);}catch(e){}
try{var _w=localStorage.getItem('da1w');if(_w)S.writing=JSON.parse(_w);}catch(e){}
...
// ════════════════════════════════════════
//  AUDIO ENGINE
//  SPK registry: texts stored in window.SPK array.
//  Buttons use onclick="spk(N)" where N is index.
//  Reset on every render() call.
//  iOS fix: NO setTimeout – speak() called synchronously in user gesture.
// ════════════════════════════════════════
window.SPK=[];

// Register a text and return the onclick string "spk(N)"
function rs(text){
  window.SPK.push(text);
  return 'spk('+(window.SPK.length-1)+')';
}

// Called from onclick attributes
window.spk=function(i){
  var t=window.SPK[i];
  if(t!==undefined)speak(t);
};
...
// iOS FIX: NO setTimeout — speak() must be called synchronously within user gesture
...
function vocabItem(v){
  ...
  var deDisplay=p?p.sg:v.de;
  var deSpeak=p?p.sg:v.de;
  return '<div class="vi"><div style="flex:1">'
    +'<div style="display:flex;align-items:center;gap:6px;margin-bottom:4px">'
    +'<span style="font-weight:600;font-size:15px">'+esc(deDisplay)+'</span>'
    +'<button onclick="'+rs(deSpeak)+'" style="background:none;border:none;cursor:pointer;font-size:15px;padding:0;-webkit-appearance:none">🔊</button>'
    +'</div>'
...
// ── QUIZ (inline onclick — no event delegation) ──
...
window._qRetry=function(){
  var src=S.quiz.src;var qs;
  if(src==='main'){
    var all=[];T.forEach(function(t){t.quiz.forEach(function(q){all.push(q);});});
    all.sort(function(){return Math.random()-0.5;});qs=all.slice(0,20);
  }else if(src&&src.charAt(0)==='g'){
    var gid=parseInt(src.slice(1),10);
    G.forEach(function(g){if(g.id===gid)qs=g.ex;});
  }else if(S.topic){qs=S.topic.quiz;}else{qs=[];}
  S.quiz={questions:qs,idx:0,sel:null,score:0,done:false,final:0,src:src};
  render();
};

function quizWidget(questions,src){
  if(S.quiz.src!==src)S.quiz={questions:questions,idx:0,sel:null,score:0,done:false,final:0,src:src};
  if(!S.quiz.questions||!S.quiz.questions.length)S.quiz.questions=questions;
  var q=S.quiz;
  if(q.done){
  ...
  var html='<div>'
    ...
    +'<p style="margin:0;font-size:16px;font-weight:500">'+esc(qi.q)+'</p></div>';
  for(var i=0;i<qi.o.length;i++){
    ...
    var click=answered?'':'onclick="window._qPick('+i+')"';
    html+='<button '+click+' style="display:block;width:100%;padding:12px 14px;margin-bottom:8px;border-radius:8px;border:'+border+';background:'+bg+';color:'+col+';cursor:'+(answered?'default':'pointer')+';text-align:left;font-size:15px;font-family:system-ui,sans-serif;-webkit-appearance:none">'+prefix+esc(qi.o[i])+'</button>';
  }
  if(answered){
...
// ── RENDER ──
function render(){
  window.SPK=[];  // reset speech registry on every render
...
window.goPage=function(p){
  if(p==='random'){S.topic=T[Math.floor(Math.random()*T.length)];S.skill='vocab';S.fc={idx:0,flipped:false};S.quiz={questions:[],idx:0,sel:null,score:0,done:false,final:0,src:null};}
  else{S.page=p;S.topic=null;S.grammar=null;if(p!=='quiz')S.quizInit=false;}
  render();
};
window.openTopic=function(id){T.forEach(function(t){if(t.id===id)S.topic=t;});S.skill='vocab';S.fc={idx:0,flipped:false};S.quiz={questions:[],idx:0,sel:null,score:0,done:false,final:0,src:null};render();};
window.openGrammar=function(id){G.forEach(function(g){if(g.id===id)S.grammar=g;});S.quiz={questions:[],idx:0,sel:null,score:0,done:false,final:0,src:null};render();};
window.goBack=function(){if(S.topic)S.topic=null;else S.grammar=null;render();};
window.setSkill=function(s){S.skill=s;S.quiz={questions:[],idx:0,sel:null,score:0,done:false,final:0,src:null};render();};
...
function homeHtml(){
  ...
  var btns=[{l:'All Topics 📚',d:'10 themes A1',c:'#e74c3c',n:'topics'},{l:'Grammar ✏️',d:'6 lessons',c:'#3498db',n:'grammar'},{l:'Verbs 🔄',d:'10 topics',c:'#1abc9c',n:'verbs'},{l:'Quiz 🏆',d:'Test everything',c:'#f39c12',n:'quiz'},{l:'Random 🎲',d:'Surprise me!',c:'#9b59b6',n:'random'}];
  ...
  btns.forEach(function(b){html+='<button onclick="goPage(\''+b.n+'\')" style="background:'+b.c+';color:#fff;border:none;border-radius:12px;padding:16px 12px;cursor:pointer;text-align:left;width:100%;-webkit-appearance:none"><div style="font-size:15px;font-weight:500">'+b.l+'</div><div style="font-size:12px;opacity:.85;margin-top:2px">'+b.d+'</div></button>';});
  ...
  T.forEach(function(t){
    html+='<button onclick="openTopic('+t.id+')" style="background:'+(S.progress[t.id]?t.light:'#fff')+';border:1.5px solid '+(S.progress[t.id]?t.color:'#e0e0e0')+';border-radius:12px;padding:12px 14px;cursor:pointer;display:flex;align-items:center;gap:10px;text-align:left;width:100%;-webkit-appearance:none">'
      ...
      +(S.progress[t.id]?'<span style="font-size:16px">✅</span>':'')+'</button>';
  });
  return html+'</div></div>';
}
...
function topicsHtml(){
  ...
  T.forEach(function(t){
    html+='<button onclick="openTopic('+t.id+')" style="background:#fff;border:1.5px solid '+(S.progress[t.id]?t.color:'#e8e8e8')+';border-radius:12px;padding:14px 16px;cursor:pointer;display:flex;align-items:center;gap:14px;text-align:left;width:100%;-webkit-appearance:none">'
      ...
      +(S.progress[t.id]?'<span style="font-size:18px">✅</span>':'<span style="color:#aaa">→</span>')+'</button>';
  });
  return html+'</div></div>';
}
...
function topicDetailHtml(){
  ...
  var html='<div>'
    ...
    +'<div><h2 style="color:#fff;font-size:20px">'+esc(t.title)+'</h2><p style="color:rgba(255,255,255,.8);font-size:13px;margin:0">'+esc(t.sub)+'</p></div></div>'
    ...
    +'<button onclick="'+rs(t.key)+'" style="background:rgba(255,255,255,.2);border:none;color:#fff;border-radius:6px;padding:4px 8px;cursor:pointer;font-size:16px;-webkit-appearance:none">🔊</button>'
    +'</div></div></div>'
    +'<div class="skill-tabs"><div class="skill-tabs-inner">';
  tabs.forEach(function(s){html+='<button onclick="setSkill(\''+s.id+'\')" class="stab'+(S.skill===s.id?' active':'')+'" style="'+(S.skill===s.id?'border-bottom-color:'+t.color+';color:'+t.color:'')+'">'+s.l+'</button>';});
  html+='</div></div><div class="page" style="padding-top:16px">'+skillHtml(t);
  if(S.skill!=='quiz')html+='<div style="text-align:center;margin-top:20px"><button onclick="markDone()" style="background:'+(S.progress[t.id]?'#1a9e5f':'#555')+';color:#fff;border:none;border-radius:8px;padding:10px 20px;cursor:pointer;font-size:14px;font-weight:500;-webkit-appearance:none">'+(S.progress[t.id]?'✅ Completed!':'Mark as completed')+'</button></div>';
  return html+'</div></div>';
}
...
function vocabSkillHtml(t){
  var fc=S.fc,card=t.vocab[fc.idx],p=parseSgPl(card.de);
  var deDisplay=p?p.sg:card.de,deSpeak=p?p.sg:card.de;
  ...
  if(!fc.flipped){
    html+='<div style="display:flex;align-items:center;gap:8px;margin-bottom:6px">'
      +'<span style="font-size:22px;font-weight:600">'+esc(deDisplay)+'</span>'
      +'<button onclick="event.stopPropagation();'+rs(deSpeak)+'" style="background:none;border:none;cursor:pointer;font-size:18px;padding:0;-webkit-appearance:none">🔊</button></div>'
    ...
    html+='<div style="font-size:16px;color:#555;font-weight:500;margin-bottom:8px">'+esc(card.vi)+'</div>'
      ...
      +'<button onclick="event.stopPropagation();'+rs(card.ex)+'" style="background:none;border:none;cursor:pointer;font-size:15px;-webkit-appearance:none">🔊 Example</button>';
  }
  html+='</div><div class="fcnav">'
...
function hoerenHtml(t){
  var lineHtml=t.reading.text.split('\n').map(function(line){
    return '<div style="display:flex;align-items:center;gap:8px;padding:6px 0;border-bottom:1px solid #f5f5f5">'
      +'<button onclick="'+rs(line)+'" style="background:none;border:none;cursor:pointer;font-size:16px;-webkit-appearance:none">🔊</button>'
      +'<span style="font-size:13px;color:#333">'+esc(line)+'</span></div>';
  }).join('');
  return '<div style="background:#f8f8f8;border-radius:12px;padding:16px;margin-bottom:16px">'
    ...
    +'<h3 style="margin-bottom:10px">🎧 Listen line by line</h3>'+lineHtml+'</div>';
}
...
function sprechenHtml(t){
    ...
    t.speakGroups.forEach(function(group){
      ...
      group.items.forEach(function(item){
        html+='<div style="background:#fff;border-radius:10px;padding:12px 14px;margin-bottom:8px">'
          ...
          +'<button onclick="'+rs(item.q)+'" style="background:none;border:none;cursor:pointer;font-size:15px;-webkit-appearance:none">🔊</button>'
          +'</div>'
          ...
          +'<button onclick="'+rs(item.a)+'" style="background:none;border:none;cursor:pointer;font-size:15px;-webkit-appearance:none">🔊</button>'
          +'</div></div>';
      });
      html+='</div>';
    });
  ...
  t.speaking.forEach(function(s){
    html2+='<div style="background:#fff;border-radius:10px;padding:12px 14px;margin-bottom:8px;display:flex;align-items:center;gap:10px">'
      +'<button onclick="'+rs(s)+'" style="background:#1abc9c;color:#fff;border:none;border-radius:6px;padding:6px 10px;cursor:pointer;font-size:15px;flex-shrink:0;-webkit-appearance:none">🔊</button>'
      +'<span style="font-size:15px">'+esc(s)+'</span></div>';
  });
  return html2+'</div>';
}
...
function lesenHtml(t){
  ...
  var qsHtml=t.reading.qs.map(function(q,i){
    ...
    return '<div style="background:#fff;border-radius:8px;padding:12px;margin-bottom:10px">'
      ...
      +(S.showAns[key]?'<p style="font-size:14px;color:#1a9e5f;font-style:italic;margin:0">✅ '+esc(q.a)+'</p>'
...
function schreibenHtml(t){
  ...
  return '<div style="background:#fff8e1;border:1px solid #FFCE00;border-radius:12px;padding:16px;margin-bottom:16px">'
    ...
    +'<p style="font-size:14px;color:#333;font-style:italic;margin:0">'+esc(t.writing.tmpl)+'</p></div>'
    ...
    +'<button onclick="'+rs(t.writing.ex)+'" style="border:1px solid #27ae60;color:#1a7a4a;border-radius:6px;padding:4px 10px;cursor:pointer;font-size:13px;background:none;-webkit-appearance:none">🔊 Listen</button>'
    +'</div>';
}
...
function grammarHtml(){
  ...
  G.forEach(function(g){
    html+='<button onclick="openGrammar('+g.id+')" style="background:#fff;border:1.5px solid #eee;border-radius:12px;padding:14px 16px;cursor:pointer;display:flex;align-items:center;gap:14px;text-align:left;width:100%;-webkit-appearance:none">'
      ...
      +'<span style="color:#aaa">→</span></button>';
  });
  return html+'</div></div>';
}
  ...
  var rulesHtml=g.rules.map(function(r){
    var exHtml=r.ex.map(function(e){
      return '<div style="display:flex;align-items:center;gap:4px">'
        ...
        +'<button onclick="'+rs(e)+'" style="background:none;border:none;cursor:pointer;font-size:13px;-webkit-appearance:none">🔊</button></div>';
    }).join('');
    return '<div class="card">'
      ...
      +'<div style="background:'+g.color+'11;border-radius:6px;padding:6px 10px;font-size:12px;color:#555">💡 '+esc(r.tip)+'</div></div>';
  }).join('');
  return '<div>'
    +'<div style="background:'+g.color+';padding:20px 16px 16px">'
    +'<button onclick="goBack()" style="background:rgba(0,0,0,.2);border:none;color:#fff;border-radius:6px;padding:4px 10px;cursor:pointer;font-size:13px;margin-bottom:12px;-webkit-appearance:none">← Back</button>'
    +'<div style="display:flex;gap:12px;align-items:center"><span style="font-size:40px">'+g.emoji+'</span>'
    +'<div><h2 style="color:#fff;font-size:19px">'+esc(g.title)+'</h2><p style="color:rgba(255,255,255,.8);font-size:13px;margin:0">'+esc(g.sub)+'</p></div></div></div>'
...
function verbsHtml(){
  ...
  Object.keys(typeColors).forEach(function(t){html+='<span style="background:'+typeColors[t]+';color:#fff;border-radius:4px;padding:3px 9px;font-size:11px">'+t+'</span>';});
  html+='</div></div>';
  VERBS.forEach(function(topic){
    ...
    html+='<div style="margin-bottom:10px;border-radius:12px;overflow:hidden;border:1.5px solid '+(open?topic.color:'#e0e0e0')+'">'
      ...
      +'<span style="font-size:18px;color:'+(open?'#fff':'#bbb')+';display:inline-block;transform:rotate('+(open?180:0)+'deg)">▼</span></button>';
    if(open){
      ...
      topic.verbs.forEach(function(v,vi){
        ...
        html+='<div style="padding:14px 16px;'+(vi<topic.verbs.length-1?'border-bottom:1px solid '+topic.color+'22':'')+'">'
          ...
          +'<button onclick="'+rs(v.inf)+'" style="background:none;border:none;cursor:pointer;font-size:15px;-webkit-appearance:none">🔊</button>'
          ...
          +'</div><div style="border-radius:8px;overflow:hidden;border:1px solid #eee">';
        for(var i=0;i<pronouns.length;i++){
          var form=v.conj[keys[i]];
          var bg=i%2===0?'#fff':'#fafafa';
          var spkText=pronouns[i].split('/')[0].trim()+' '+form;
          html+='<div style="display:grid;grid-template-columns:110px 1fr 36px;background:'+bg+';border-bottom:'+(i<5?'1px solid #f0f0f0':'none')+'">'
            ...
            +'<button onclick="'+rs(spkText)+'" style="background:none;border:none;cursor:pointer;font-size:14px;-webkit-appearance:none">🔊</button>'
            +'</div></div>';
        }
        html+='</div></div>';
      });
...
function quizPageHtml(){
  ...
  return '<div class="page">'
    ...
    +'<p style="font-size:13px;opacity:.85;margin:0">20 random questions · Viel Erfolg!</p></div>'
    +'<div class="card">'+quizWidget(S.quiz.questions,'main')+'</div></div>';
}
